...
public class Client implements ActionListener
{
    ...
    Client()
    {
       f.setLayout(null);//frame ka layout ignore kar rahe hai hum apna banayenge layout
       ...
       ImageIcon i3=new ImageIcon(i2);//direct i2 ko JLabel me pass nahi kar sakte the
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        try
        {
            ...
            vertical.add(right);
            vertical.add(Box.createVerticalStrut(15));//vertical spaceing
